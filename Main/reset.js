// require all of your classes x
// require inquirer, path if needed, fs x

// require your page template x

// empty team members array x
// empty id array x 


// function that wraps everything (like an init function) x
